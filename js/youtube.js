...
$(document).ready(function(){
  ...
  $('#buttonBox-hidden-video li A').on('click',function(e){
    ...
    if($(window).width() > 800){
      ...
      // build player
      $('#mPlayer DIV').html('<iframe width="560" height="315" src="https://www.youtube.com/embed/' + i + '?autoplay=1" frameborder="0" allowfullscreen></iframe>');
